...
public class Save : MonoBehaviour
{
    ...
    public void SaveOptions() {
        print("Saving options: Volume: " + source.soundSystem.GetVolume() + " HIghestLevel: " + source.options.HighestLevel + " ShowHintBoards: " + source.options.ShowHintBoards);
        ES3.Save<float>(persistance.VOLUME, source.soundSystem.GetVolume());
